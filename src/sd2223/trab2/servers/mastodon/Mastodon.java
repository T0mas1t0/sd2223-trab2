...
public class Mastodon implements Feeds {
	...
	private static final String clientKey = "gknUkJMrf2uT4J2R9tTRWcH9XQe-4HiCB1iskIHPfAw";
	private static final String clientSecret = "Onv2y8CINqxjiEqgHZ2r1153D7wNKDdotmkEr8DjfVQ";
	private static final String accessTokenStr = "pt3-byrdBgsAEaFX37sVi8hoxqcLrMi15vrsLym7rS4";
	...
	public Result<Void> removeFromPersonalFeed(String user, long mid, String pwd) {
		try {
			final OAuthRequest request = new OAuthRequest(Verb.DELETE, getEndpoint(ACCOUNT_FOLLOWING_PATH));
